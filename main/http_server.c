...
// Queue handle used to manipulate main queue of the events
...
static httpd_handle_t http_server_configure(void)
{
    ...
    ESP_LOGI(TAG, "http_server_start: configuring HTTP server");
...
{
    ESP_LOGI(TAG, "http_server_start: starting HTTP server");
